...
salida.innerHTML += `<br>nombre: ${suscriptor1.nombre}, Plan: ${suscriptor1.plan},conexion: $${suscriptor1.Adicional()}, Precio por suscriptor: $${suscriptor1.precioPsus()}</br>` 
salida.innerHTML += `<br>nombre: ${suscriptor2.nombre}, Plan: ${suscriptor2.plan},conexion: $${suscriptor2.Adicional()}, Precio por suscriptor: $${suscriptor2.precioPsus()}</br>`
salida.innerHTML += `<br>nombre: ${suscriptor3.nombre}, Plan: ${suscriptor3.plan},conexion: $${suscriptor3.Adicional()}, Precio por suscriptor: $${suscriptor3.precioPsus()}</br>`
salida.innerHTML += `<br>nombre: ${suscriptor4.nombre}, Plan: ${suscriptor4.plan},conexion: $${suscriptor4.Adicional()}, Precio por suscriptor: $${suscriptor4.precioPsus()}</br>`
salida.innerHTML += `<br>nombre: ${suscriptor5.nombre}, Plan: ${suscriptor5.plan},conexion: $${suscriptor5.Adicional()}, Precio por suscriptor: $${suscriptor5.precioPsus()}</br>`
salida.innerHTML += `<br>nombre: ${suscriptor6.nombre}, Plan: ${suscriptor6.plan},conexion: $${suscriptor6.Adicional()}, Precio por suscriptor: $${suscriptor6.precioPsus()}</br>`
